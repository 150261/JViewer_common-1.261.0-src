...
public class UserDataPacket {
	public static final int USER_DATA_LENGTH = 130;//64+65+1(UserName+ClientIP+SessionID)
	...
	public UserDataPacket(ByteBuffer userListBuffer){
		...
		for(int count = 0; count < numUsers; count++){
			...
			keyString = userData.getSessionIndex()+ " : " +userData.getUserName() + " : " + userData.getClientIP();
