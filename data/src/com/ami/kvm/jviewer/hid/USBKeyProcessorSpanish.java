...
public class USBKeyProcessorSpanish implements KeyProcessor
{
    ...
    public USBKeyProcessorSpanish()
    {
        ...
        SpanishMap = new HashMap<Integer, Integer>();
...
//        map.put( KeyEvent.VK_???, 158 );
        ...
        SpanishMap.put(KeyEvent.VK_QUOTE, KeyEvent.VK_MINUS);
        SpanishMap.put(KeyEvent.VK_INVERTED_EXCLAMATION_MARK,KeyEvent.VK_EQUALS);
        SpanishMap.put(KeyEvent.VK_DEAD_GRAVE,KeyEvent.VK_OPEN_BRACKET );
        SpanishMap.put(KeyEvent.VK_PLUS,KeyEvent.VK_CLOSE_BRACKET);
        SpanishMap.put(KeyEvent.VK_DEAD_ACUTE,KeyEvent.VK_QUOTE );
        SpanishMap.put(KeyEvent.VK_MINUS,KeyEvent.VK_SLASH );
