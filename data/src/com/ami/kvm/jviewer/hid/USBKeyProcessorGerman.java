...
public class USBKeyProcessorGerman implements KeyProcessor
{
    ...
    public USBKeyProcessorGerman()
    {
        ...
        GermanMap = new HashMap<Integer, Integer>();
...
//        map.put( KeyEvent.VK_???, 158 );
        ...
        GermanMap.put(KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_EQUALS);
        GermanMap.put(KeyEvent.VK_PLUS, KeyEvent.VK_CLOSE_BRACKET);
        GermanMap.put(KeyEvent.VK_NUMBER_SIGN, KeyEvent.VK_BACK_SLASH);
        GermanMap.put(KeyEvent.VK_Y, KeyEvent.VK_Z);
        GermanMap.put(KeyEvent.VK_Z, KeyEvent.VK_Y);
        GermanMap.put(KeyEvent.VK_MINUS, KeyEvent.VK_SLASH);
        GermanMap.put(KeyEvent.VK_DEAD_CIRCUMFLEX, KeyEvent.VK_BACK_QUOTE);
        GermanMap.put(KeyEvent.VK_SLASH, KeyEvent.VK_MINUS);
