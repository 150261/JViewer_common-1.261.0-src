...
public class USBKeyProcessorFrench implements KeyProcessor
{
    ...
    public USBKeyProcessorFrench()
    {
        ...
        FrenchMap = new HashMap<Integer, Integer>();
        ...
        keypadMap.put( KeyEvent.VK_DELETE, 99 );
...
//        map.put( KeyEvent.VK_???, 158 );
        ...
        FrenchMap.put(KeyEvent.VK_RIGHT_PARENTHESIS, KeyEvent.VK_MINUS);
        FrenchMap.put(KeyEvent.VK_DEAD_CIRCUMFLEX, KeyEvent.VK_OPEN_BRACKET);
        FrenchMap.put(KeyEvent.VK_DOLLAR, KeyEvent.VK_CLOSE_BRACKET);
        FrenchMap.put(KeyEvent.VK_M, KeyEvent.VK_SEMICOLON);
        FrenchMap.put(KeyEvent.VK_ASTERISK, KeyEvent.VK_BACK_SLASH);
        FrenchMap.put(KeyEvent.VK_COMMA, KeyEvent.VK_M);
        FrenchMap.put(KeyEvent.VK_SEMICOLON, KeyEvent.VK_COMMA);
        FrenchMap.put(KeyEvent.VK_COLON, KeyEvent.VK_PERIOD);
        FrenchMap.put(KeyEvent.VK_EXCLAMATION_MARK, KeyEvent.VK_SLASH);
        FrenchMap.put(KeyEvent.VK_A, KeyEvent.VK_Q);
        FrenchMap.put(KeyEvent.VK_Z, KeyEvent.VK_W);
        FrenchMap.put(KeyEvent.VK_W, KeyEvent.VK_Z);
        FrenchMap.put(KeyEvent.VK_Q, KeyEvent.VK_A);
        if(System.getProperty("os.name").equals("Linux"))
        {
	        FrenchMap.put(KeyEvent.VK_AMPERSAND, KeyEvent.VK_1);
	        FrenchMap.put(KeyEvent.VK_QUOTE, KeyEvent.VK_4);
	        FrenchMap.put(KeyEvent.VK_LEFT_PARENTHESIS, KeyEvent.VK_5);
	        FrenchMap.put(KeyEvent.VK_MINUS, KeyEvent.VK_6);
	        FrenchMap.put(KeyEvent.VK_UNDERSCORE, KeyEvent.VK_8);
        }

        //Get the modifier key status from the default key processor and set it as the modifier value.
